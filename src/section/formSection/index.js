...
const FormSection = () => {
  ...
  return (
    ...
    >
      <div className="container flex max-md:flex-col gap-[120px] max-md:gap-10">
        ...
        <div className="flex w-full items-end justify-end">
          <div className="bg-white w-fit py-2 px-4 rounded-full hover:bg-primary-brand hover:text-black hover:cursor-pointer duration-200">SUBMIT</div>
        </div>
        </div>
      </div>
    </section>
